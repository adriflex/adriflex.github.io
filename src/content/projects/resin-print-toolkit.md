...
date: 2024-10-01
tags: [blender, asset-pack, geometry-nodes, 3d, impression-3d]
featured: false
color: "#0f766e"
status: published
...
<iframe src="https://www.youtube.com/embed/d9IObfPWU7I" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;" allow="accelerometer;autoplay;clipboard-write;encrypted-media;gyroscope;picture-in-picture" allowfullscreen></iframe>
</div>

Geometry Nodes permet de créer à peu près n'importe quel outil procédural dans Blender. Ici, je m'en suis servi pour générer des supports d'impression résine : des supports curvés qui viennent chercher les parties isolées du modèle, les zones en surplomb, les points délicats. On ajuste la densité, la taille, le placement — tout reste dans Blender.

![Démo des supports procéduraux en action](/images/resin-print-toolkit-demo.gif)
